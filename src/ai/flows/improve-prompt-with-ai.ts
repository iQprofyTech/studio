'use server';
/**
 * @fileOverview An AI agent that improves user prompts for better content generation.
 *
 * - improvePrompt - A function that takes a user prompt and returns an improved prompt.
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI prompt engineer. Your goal is to improve the user's prompt to generate better content.\n\nUser Prompt: {{{prompt}}}\n\nImproved Prompt:`, 
});
